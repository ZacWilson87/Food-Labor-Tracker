...
class GoogleCloudStorage extends drive_1.Storage {
    constructor(config) {
        ...
        this.$root = config.root ? normalize_path_1.default(config.root).replace(/^\//, '') : '';
    }
    /**
     * Prefixes the given filePath with the storage root location
     */
    _fullPath(filePath) {
        return normalize_path_1.default(path_1.default.join(this.$root, filePath));
    }
    _file(filePath) {
    ...
    async delete(location) {
        try {
            ...
            if (e instanceof drive_1.FileNotFound) {
    ...
    async put(location, content) {
        ...
        try {
            if (drive_1.isReadableStream(content)) {
                ...
                await drive_1.pipeline(content, destStream);
