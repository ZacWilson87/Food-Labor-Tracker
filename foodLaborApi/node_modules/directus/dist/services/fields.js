...
class FieldsService {
    ...
    createField(collection, field, table // allows collection creation to
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield this.knex.transaction((trx) => __awaiter(this, void 0, void 0, function* () {
                ...
                if (field.meta) {
                    yield itemsService.createOne(Object.assign(Object.assign({}, field.meta), { collection: collection, field: field.field }));
                }
            }));
    ...
    updateField(collection, field) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (field.meta) {
                const record = yield this.knex
                    .select('id')
                    .from('directus_fields')
                    .where({ collection, field: field.field })
                    .first();
                if (record) {
                    yield this.itemsService.updateOne(record.id, Object.assign(Object.assign({}, field.meta), { collection: collection, field: field.field }));
                }
                else {
                    yield this.itemsService.createOne(Object.assign(Object.assign({}, field.meta), { collection: collection, field: field.field }));
                }
            }
            if (cache_1.default && env_1.default.CACHE_AUTO_PURGE) {
                yield cache_1.default.clear();
    ...
    deleteField(collection, field) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield emitter_1.default.emitAsync(`fields.delete.before`, {
            ...
            const collectionMeta = yield this.knex
            ...
            if (Object.keys(collectionMetaUpdates).length > 0) {
                yield this.knex('directus_collections').update(collectionMetaUpdates).where({ collection });
            }
            if (cache_1.default && env_1.default.CACHE_AUTO_PURGE) {
                yield cache_1.default.clear();
            }
            emitter_1.emitAsyncSafe(`fields.delete`, {
                event: `fields.delete`,
                accountability: this.accountability,
                collection: collection,
                item: field,
