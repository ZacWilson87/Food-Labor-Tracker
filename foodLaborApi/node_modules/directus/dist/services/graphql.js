...
exports.GraphQLService = exports.GraphQLDate = void 0;
...
exports.GraphQLDate = new graphql_1.GraphQLScalarType(Object.assign(Object.assign({}, graphql_1.GraphQLString), { name: 'Date', description: 'ISO8601 Date values' }));
/**
...
class GraphQLService {
     ...
     */
    execute({ document, variables, operationName, contextValue }) {
        var _a;
        return __awaiter(this, void 0, void 0, function* () {
            const schema = this.getSchema();
            const validationErrors = graphql_1.validate(schema, document, graphql_1.specifiedRules);
            if (validationErrors.length > 0) {
                throw new exceptions_1.GraphQLValidationException({ graphqlErrors: validationErrors });
            }
            let result;
            try {
                result = yield graphql_1.execute({
                    schema,
                    document,
                    contextValue,
            ...
            const formattedResult = Object.assign(Object.assign({}, result), { errors: (_a = result.errors) === null || _a === void 0 ? void 0 : _a.map(graphql_1.formatError) });
    ...
    getSchema(type = 'schema') {
        ...
        const schema = {
            read: ((_a = this.accountability) === null || _a === void 0 ? void 0 : _a.admin) === true ? this.schema : reduce_schema_1.reduceSchema(this.schema, ['read']),
            create: ((_b = this.accountability) === null || _b === void 0 ? void 0 : _b.admin) === true ? this.schema : reduce_schema_1.reduceSchema(this.schema, ['create']),
            update: ((_c = this.accountability) === null || _c === void 0 ? void 0 : _c.admin) === true ? this.schema : reduce_schema_1.reduceSchema(this.schema, ['update']),
            delete: ((_d = this.accountability) === null || _d === void 0 ? void 0 : _d.admin) === true ? this.schema : reduce_schema_1.reduceSchema(this.schema, ['delete']),
        };
        ...
        function getTypes(action) {
            ...
            for (const collection of Object.values(schema[action].collections)) {
                ...
                CollectionTypes[collection.collection] = schemaComposer.createObjectTC({
                    ...
                    fields: Object.values(collection.fields).reduce((acc, field) => {
                        acc[field.field] = {
                            type: get_graphql_type_1.getGraphQLType(field.type),
            ...
            for (const relation of schema[action].relations) {
                if (relation.one_collection) {
                    (_a = CollectionTypes[relation.many_collection]) === null || _a === void 0 ? void 0 : _a.addFields({
                        [relation.many_field]: {
                            type: CollectionTypes[relation.one_collection],
                        },
                    });
                    if (relation.one_field) {
                        (_b = CollectionTypes[relation.one_collection]) === null || _b === void 0 ? void 0 : _b.addFields({
                            [relation.one_field]: {
                    ...
                    (_c = CollectionTypes[relation.many_collection]) === null || _c === void 0 ? void 0 : _c.addFields({
                        [relation.many_field]: {
        ...
        function getReadableTypes() {
            ...
            for (const collection of Object.values(schema.read.collections)) {
                ...
                ReadableCollectionFilterTypes[collection.collection] = schemaComposer.createInputTC({
                    ...
                    fields: Object.values(collection.fields).reduce((acc, field) => {
                        const graphqlType = get_graphql_type_1.getGraphQLType(field.type);
                ...
                ReadCollectionTypes[collection.collection].addResolver({
                    ...
                    type: collection.singleton
                        ...
                        : [ReadCollectionTypes[collection.collection]],
                    resolve: ({ info, context }) => __awaiter(this, void 0, void 0, function* () {
                        const result = yield self.resolveQuery(info);
                        context.data = result;
                        return result;
                    }),
                });
                if (collection.singleton === false) {
                    ReadCollectionTypes[collection.collection].addResolver({
                        ...
                        args: {
                            id: graphql_1.GraphQLNonNull(graphql_1.GraphQLID),
                        },
                        resolve: ({ info, context }) => __awaiter(this, void 0, void 0, function* () {
                            const result = yield self.resolveQuery(info);
                            context.data = result;
            ...
            for (const relation of schema.read.relations) {
                if (relation.one_collection) {
                    (_a = ReadableCollectionFilterTypes[relation.many_collection]) === null || _a === void 0 ? void 0 : _a.addFields({
                        [relation.many_field]: ReadableCollectionFilterTypes[relation.one_collection],
                    });
                    (_b = ReadCollectionTypes[relation.many_collection]) === null || _b === void 0 ? void 0 : _b.addFieldArgs(relation.many_field, {
                    ...
                    if (relation.one_field) {
                        (_c = ReadableCollectionFilterTypes[relation.one_collection]) === null || _c === void 0 ? void 0 : _c.addFields({
                            [relation.one_field]: ReadableCollectionFilterTypes[relation.many_collection],
                        });
                        (_d = ReadCollectionTypes[relation.one_collection]) === null || _d === void 0 ? void 0 : _d.addFieldArgs(relation.one_field, {
        ...
        function getWritableTypes() {
                ...
                if (Object.keys(creatableFields).length > 0) {
                    CreateCollectionTypes[collection.collection].addResolver({
                        ...
                        args: collectionIsReadable
                            ...
                            : undefined,
                        resolve: ({ args, info }) => __awaiter(this, void 0, void 0, function* () { return yield self.resolveMutation(args, info); }),
                    });
                    CreateCollectionTypes[collection.collection].addResolver({
                    ...
                    CreateCollectionTypes[collection.collection].getResolver(`create_${collection.collection}_items`).addArgs(Object.assign(Object.assign({}, CreateCollectionTypes[collection.collection]
                        .getResolver(`create_${collection.collection}_items`)
                        .getArgs()), { data: [
                            graphql_compose_1.toInputObjectType(CreateCollectionTypes[collection.collection]).setTypeName(`create_${collection.collection}_input`).NonNull,
                        ] }));
                    CreateCollectionTypes[collection.collection].getResolver(`create_${collection.collection}_item`).addArgs(Object.assign(Object.assign({}, CreateCollectionTypes[collection.collection]
                        .getResolver(`create_${collection.collection}_item`)
                        .getArgs()), { data: graphql_compose_1.toInputObjectType(CreateCollectionTypes[collection.collection]).setTypeName(`create_${collection.collection}_input`).NonNull }));
                }
            }
                ...
                if (Object.keys(updatableFields).length > 0) {
                    if (collection.singleton) {
                        UpdateCollectionTypes[collection.collection].addResolver({
                            ...
                            type: collectionIsReadable ? ReadCollectionTypes[collection.collection] : graphql_1.GraphQLBoolean,
                            args: {
                                data: graphql_compose_1.toInputObjectType(UpdateCollectionTypes[collection.collection]).setTypeName(`update_${collection.collection}_input`).NonNull,
                            },
                            resolve: ({ args, info }) => __awaiter(this, void 0, void 0, function* () { return yield self.resolveMutation(args, info); }),
                        });
                    }
                        ...
                        UpdateCollectionTypes[collection.collection].addResolver({
                            ...
                            type: collectionIsReadable ? [ReadCollectionTypes[collection.collection]] : graphql_1.GraphQLBoolean,
                            args: Object.assign(Object.assign({}, (collectionIsReadable
                                ? ReadCollectionTypes[collection.collection].getResolver(collection.collection).getArgs()
                                : {})), { ids: graphql_1.GraphQLNonNull(new graphql_1.GraphQLList(graphql_1.GraphQLID)), data: graphql_compose_1.toInputObjectType(UpdateCollectionTypes[collection.collection]).setTypeName(`update_${collection.collection}_input`).NonNull }),
                            resolve: ({ args, info }) => __awaiter(this, void 0, void 0, function* () { return yield self.resolveMutation(args, info); }),
                        });
                        UpdateCollectionTypes[collection.collection].addResolver({
            ...
            DeleteCollectionTypes.many = schemaComposer.createObjectTC({
                name: `delete_many`,
                fields: {
                    ids: graphql_1.GraphQLNonNull(new graphql_1.GraphQLList(graphql_1.GraphQLID)),
                },
            });
    ...
    resolveQuery(info) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const result = yield this.read(collection, query);
            if (args.id) {
    ...
    resolveMutation(args, info) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (singleton && action === 'update') {
                return yield this.upsertSingleton(collection, args.data, query);
            }
            ...
            try {
                if (single) {
                    if (action === 'create') {
                        const key = yield service.createOne(args.data);
                        return hasQuery ? yield service.readOne(key, query) : true;
                    }
                    if (action === 'update') {
                        const key = yield service.updateOne(args.id, args.data);
                        return hasQuery ? yield service.readOne(key, query) : true;
                    }
                    if (action === 'delete') {
                        yield service.deleteOne(args.id);
                        return { id: args.id };
                    }
                }
                else {
                    if (action === 'create') {
                        const keys = yield service.createMany(args.data);
                        return hasQuery ? yield service.readMany(keys, query) : true;
                    }
                    if (action === 'update') {
                        const keys = yield service.updateMany(args.ids, args.data);
                        return hasQuery ? yield service.readMany(keys, query) : true;
                    }
                    if (action === 'delete') {
                        const keys = yield service.deleteMany(args.ids);
                        return { ids: keys };
                    }
                }
            }
     ...
     */
    upsertSingleton(collection, body, query) {
        return __awaiter(this, void 0, void 0, function* () {
            const service = this.getService(collection);
            try {
                yield service.upsertSingleton(body);
                if ((query.fields || []).length > 0) {
                    const result = yield service.readSingleton(query);
                    return result;
                }
                return true;
            }
    ...
    getQuery(rawQuery, selections, variableValues) {
        const query = sanitize_query_1.sanitizeQuery(rawQuery, this.accountability);
    ...
    getService(collection) {
        ...
        switch (collection) {
            ...
            case 'directus_relations':
                return new relations_1.RelationsService(opts);
    ...
    replaceFragmentsInSelections(selections, fragments) {
        if (!selections)
            return null;
        const result = lodash_1.flatten(selections.map((selection) => {
    ...
    injectSystemResolvers(schemaComposer, { CreateCollectionTypes, ReadCollectionTypes, UpdateCollectionTypes, DeleteCollectionTypes, }, schema) {
        ...
        schemaComposer.Query.addFields({
            extensions: {
                ...
                resolve: () => __awaiter(this, void 0, void 0, function* () {
                    return ({
                        interfaces: yield extensions_1.listExtensions('interfaces'),
                        displays: yield extensions_1.listExtensions('displays'),
                        layouts: yield extensions_1.listExtensions('layouts'),
                        modules: yield extensions_1.listExtensions('modules'),
                    });
                }),
            },
            server_specs_oas: {
                ...
                resolve: () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return yield service.oas.generate();
                }),
            },
            server_specs_graphql: {
                ...
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const service = new GraphQLService({
                        schema: this.schema,
                        accountability: this.accountability,
                        scope: (_f = args.scope) !== null && _f !== void 0 ? _f : 'items',
                    });
            ...
            server_info: {
                ...
                resolve: () => __awaiter(this, void 0, void 0, function* () {
                    ...
                    return yield service.serverInfo();
                }),
            },
            server_health: {
                type: graphql_compose_1.GraphQLJSON,
        ...
        schemaComposer.Mutation.addFields({
            auth_login: {
                type: AuthTokens,
                args: {
                    email: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    password: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    mode: AuthMode,
                    otp: graphql_1.GraphQLString,
                },
                resolve: (_, args, { req, res }) => __awaiter(this, void 0, void 0, function* () {
                    var _g;
                    ...
                    const result = yield authenticationService.authenticate(Object.assign(Object.assign({}, args), { ip: req === null || req === void 0 ? void 0 : req.ip, userAgent: req === null || req === void 0 ? void 0 : req.get('user-agent') }));
                    if (args.mode === 'cookie') {
                        res === null || res === void 0 ? void 0 : res.cookie('directus_refresh_token', result.refreshToken, {
                            httpOnly: true,
                            domain: env_1.default.REFRESH_TOKEN_COOKIE_DOMAIN,
                            maxAge: ms_1.default(env_1.default.REFRESH_TOKEN_TTL),
                            secure: (_g = env_1.default.REFRESH_TOKEN_COOKIE_SECURE) !== null && _g !== void 0 ? _g : false,
            ...
            auth_refresh: {
                ...
                resolve: (_, args, { req, res }) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const currentRefreshToken = args.refresh_token || (req === null || req === void 0 ? void 0 : req.cookies.directus_refresh_token);
                    if (!currentRefreshToken) {
                        throw new exceptions_1.InvalidPayloadException(`"refresh_token" is required in either the JSON payload or Cookie`);
                    }
                    const result = yield authenticationService.refresh(currentRefreshToken);
                    if (args.mode === 'cookie') {
                        res === null || res === void 0 ? void 0 : res.cookie('directus_refresh_token', result.refreshToken, {
                            httpOnly: true,
                            domain: env_1.default.REFRESH_TOKEN_COOKIE_DOMAIN,
                            maxAge: ms_1.default(env_1.default.REFRESH_TOKEN_TTL),
                            secure: (_h = env_1.default.REFRESH_TOKEN_COOKIE_SECURE) !== null && _h !== void 0 ? _h : false,
                            sameSite: env_1.default.REFRESH_TOKEN_COOKIE_SAME_SITE || 'strict',
                        });
                    }
                    return {
            ...
            auth_logout: {
                ...
                resolve: (_, args, { req }) => __awaiter(this, void 0, void 0, function* () {
                    const accountability = {
                        ip: req === null || req === void 0 ? void 0 : req.ip,
                        userAgent: req === null || req === void 0 ? void 0 : req.get('user-agent'),
                        role: null,
            ...
            auth_password_request: {
                ...
                resolve: (_, args, { req }) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    try {
                        yield service.requestPasswordReset(args.email, args.reset_url || null);
                    }
                    catch (err) {
            ...
            auth_password_reset: {
                type: graphql_1.GraphQLBoolean,
                args: {
                    token: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    password: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                },
                resolve: (_, args, { req }) => __awaiter(this, void 0, void 0, function* () {
                    const accountability = {
                    ...
                    const service = new users_1.UsersService({ accountability, schema: this.schema });
                    yield service.resetPassword(args.token, args.password);
                    return true;
                }),
            },
            users_me_tfa_enable: {
                ...
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield authService.verifyPassword(this.accountability.user, args.password);
                    const { url, secret } = yield service.enableTFA(this.accountability.user);
            ...
            users_me_tfa_disable: {
                type: graphql_1.GraphQLBoolean,
                args: {
                    otp: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                },
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    var _k;
                    if (!((_k = this.accountability) === null || _k === void 0 ? void 0 : _k.user))
                        return null;
                    const service = new users_1.UsersService({
                        accountability: this.accountability,
                        schema: this.schema,
                    ...
                    const otpValid = yield authService.verifyOTP(this.accountability.user, args.otp);
                    if (otpValid === false) {
                        throw new exceptions_1.InvalidPayloadException(`"otp" is invalid`);
                    }
                    yield service.disableTFA(this.accountability.user);
                    return true;
                }),
            },
            utils_hash_generate: {
                type: graphql_1.GraphQLString,
                args: {
                    string: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                },
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    return yield argon2_1.default.hash(args.string);
                }),
            },
            utils_hash_verify: {
                type: graphql_1.GraphQLBoolean,
                args: {
                    string: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    hash: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                },
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    return yield argon2_1.default.verify(args.hash, args.string);
                }),
            },
            utils_sort: {
                type: graphql_1.GraphQLBoolean,
                args: {
                    collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    item: graphql_1.GraphQLNonNull(graphql_1.GraphQLID),
                    to: graphql_1.GraphQLNonNull(graphql_1.GraphQLID),
                },
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const { item, to } = args;
                    yield service.sort(args.collection, { item, to });
                    return true;
                }),
            },
            utils_revert: {
                type: graphql_1.GraphQLBoolean,
                args: {
                    revision: graphql_1.GraphQLNonNull(graphql_1.GraphQLID),
                },
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield service.revert(args.revision);
                    return true;
                }),
            },
            users_invite_accept: {
                ...
                resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                    ...
                    yield service.acceptInvite(args.token, args.password);
                    return true;
                }),
            },
        });
            ...
            schemaComposer.Query.addFields({
                collections: {
                    ...
                    resolve: () => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return yield collectionsService.readByQuery();
                    }),
                },
                collections_by_name: {
                    type: Collection,
                    args: {
                        name: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    },
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        const collectionsService = new collections_1.CollectionsService({
                            accountability: this.accountability,
                        ...
                        return yield collectionsService.readOne(args.name);
                    }),
                },
            });
        }
            ...
            schemaComposer.Query.addFields({
                ...
                fields_in_collection: {
                    ...
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        return yield service.readAll(args.collection);
                    }),
                },
                fields_by_name: {
                    type: Field,
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        field: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    },
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        const service = new fields_1.FieldsService({
                            accountability: this.accountability,
                        ...
                        return yield service.readOne(args.collection, args.field);
                    }),
                },
            });
        }
        if (((_b = this.accountability) === null || _b === void 0 ? void 0 : _b.admin) === true) {
            schemaComposer.Mutation.addFields({
                create_collections_item: {
                    type: Collection,
                    args: {
                        data: graphql_compose_1.toInputObjectType(Collection.clone('create_directus_collections'), {
                            postfix: '_input',
                        }).addFields({
                            fields: [
                                graphql_compose_1.toInputObjectType(Field.clone('create_directus_collections_fields'), { postfix: '_input' }).NonNull,
                            ],
                        }).NonNull,
                    },
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const collectionKey = yield collectionsService.createOne(args.data);
                        return yield collectionsService.readOne(collectionKey);
                    }),
                },
                update_collections_item: {
                    ...
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        data: graphql_compose_1.toInputObjectType(Collection.clone('update_directus_collections'), {
                            postfix: '_input',
                    ...
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const collectionKey = yield collectionsService.updateOne(args.collection, args.data);
                        return yield collectionsService.readOne(collectionKey);
                    }),
                },
                delete_collections_item: {
                    ...
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield collectionsService.deleteOne(args.collection);
            ...
            schemaComposer.Mutation.addFields({
                create_fields_item: {
                    ...
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        data: graphql_compose_1.toInputObjectType(Field.clone('create_directus_fields'), { postfix: '_input' }).NonNull,
                    },
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        const service = new fields_1.FieldsService({
                            accountability: this.accountability,
                        ...
                        yield service.createField(args.collection, args.data);
                        return yield service.readOne(args.collection, args.data.field);
                    }),
                },
                update_fields_item: {
                    type: Field,
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        field: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        data: graphql_compose_1.toInputObjectType(Field.clone('update_directus_fields'), { postfix: '_input' }).NonNull,
                    },
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        const service = new fields_1.FieldsService({
                            accountability: this.accountability,
                        ...
                        yield service.updateField(args.collection, Object.assign(Object.assign({}, args.data), { field: args.field }));
                        return yield service.readOne(args.collection, args.data.field);
                    }),
                },
                delete_fields_item: {
                    ...
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield service.deleteField(args.collection, args.field);
        ...
        if ('directus_users' in schema.read.collections) {
            schemaComposer.Query.addFields({
                users_me: {
                    ...
                    resolve: (_, args, __, info) => __awaiter(this, void 0, void 0, function* () {
                        var _l, _m, _o;
                        if (!((_l = this.accountability) === null || _l === void 0 ? void 0 : _l.user))
                            return null;
                        const service = new users_1.UsersService({ schema: this.schema, accountability: this.accountability });
                        const selections = this.replaceFragmentsInSelections((_o = (_m = info.fieldNodes[0]) === null || _m === void 0 ? void 0 : _m.selectionSet) === null || _o === void 0 ? void 0 : _o.selections, info.fragments);
                        const query = this.getQuery(args, selections || [], info.variableValues);
                        return yield service.readOne(this.accountability.user, query);
                    }),
                },
            });
        }
            ...
            schemaComposer.Mutation.addFields({
                create_comment: {
                    ...
                    args: {
                        collection: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        item: graphql_1.GraphQLNonNull(graphql_1.GraphQLID),
                        comment: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    },
                    resolve: (_, args, __, info) => __awaiter(this, void 0, void 0, function* () {
                        var _p, _q, _r, _s, _t;
                        ...
                        const primaryKey = yield service.createOne(Object.assign(Object.assign({}, args), { action: types_1.Action.COMMENT, user: (_p = this.accountability) === null || _p === void 0 ? void 0 : _p.user, ip: (_q = this.accountability) === null || _q === void 0 ? void 0 : _q.ip, user_agent: (_r = this.accountability) === null || _r === void 0 ? void 0 : _r.userAgent }));
                        if ('directus_activity' in ReadCollectionTypes) {
                            const selections = this.replaceFragmentsInSelections((_t = (_s = info.fieldNodes[0]) === null || _s === void 0 ? void 0 : _s.selectionSet) === null || _t === void 0 ? void 0 : _t.selections, info.fragments);
                            const query = this.getQuery(args, selections || [], info.variableValues);
                            return yield service.readOne(primaryKey, query);
                        }
                        return true;
                    }),
                },
            ...
            schemaComposer.Mutation.addFields({
                update_comment: {
                    ...
                    resolve: (_, args, __, info) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        const primaryKey = yield service.updateOne(args.id, { comment: args.comment });
                        if ('directus_activity' in ReadCollectionTypes) {
                            const selections = this.replaceFragmentsInSelections((_v = (_u = info.fieldNodes[0]) === null || _u === void 0 ? void 0 : _u.selectionSet) === null || _v === void 0 ? void 0 : _v.selections, info.fragments);
                            const query = this.getQuery(args, selections || [], info.variableValues);
                            return yield service.readOne(primaryKey, query);
                        }
                        return true;
        ...
        if ('directus_files' in schema.create.collections) {
            schemaComposer.Mutation.addFields({
                import_file: {
                    ...
                    args: {
                        url: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        data: graphql_compose_1.toInputObjectType(CreateCollectionTypes['directus_files']).setTypeName('create_directus_files_input'),
                    },
                    resolve: (_, args, __, info) => __awaiter(this, void 0, void 0, function* () {
                        var _w, _x;
                        ...
                        const primaryKey = yield service.importOne(args.url, args.data);
                        if ('directus_files' in ReadCollectionTypes) {
                            const selections = this.replaceFragmentsInSelections((_x = (_w = info.fieldNodes[0]) === null || _w === void 0 ? void 0 : _w.selectionSet) === null || _x === void 0 ? void 0 : _x.selections, info.fragments);
                            const query = this.getQuery(args, selections || [], info.variableValues);
                            return yield service.readOne(primaryKey, query);
                        }
                        return true;
        ...
        if ('directus_users' in schema.create.collections) {
            schemaComposer.Mutation.addFields({
                users_invite: {
                    ...
                    args: {
                        email: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                        role: graphql_1.GraphQLNonNull(graphql_1.GraphQLString),
                    ...
                    resolve: (_, args) => __awaiter(this, void 0, void 0, function* () {
                        ...
                        yield service.inviteUser(args.email, args.role, args.invite_url || null);
                        return true;
                    }),
                },
            });
