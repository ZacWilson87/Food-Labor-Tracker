...
class GraphQLSpecsService {
    constructor(options) {
        ...
        this.knex = options.knex || database_1.default;
        this.schema = options.schema;
        this.items = new graphql_1.GraphQLService(Object.assign(Object.assign({}, options), { scope: 'items' }));
        this.system = new graphql_1.GraphQLService(Object.assign(Object.assign({}, options), { scope: 'system' }));
    }
    generate(scope) {
        return __awaiter(this, void 0, void 0, function* () {
            if (scope === 'items')
