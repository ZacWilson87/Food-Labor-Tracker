...
class AuthorizationService {
    ...
    processAST(ast, action = 'read') {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let permissionsForCollections = lodash_1.uniqWith(this.schema.permissions.filter((permission) => {
    ...
    checkAccess(action, collection, pk) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (Array.isArray(pk)) {
                const result = yield itemsService.readMany(pk, query, { permissionsAction: action });
                if (!result)
                    throw new exceptions_1.ForbiddenException();
                ...
                const result = yield itemsService.readOne(pk, query, { permissionsAction: action });
                if (!result)
                    throw new exceptions_1.ForbiddenException();
            }
        });
