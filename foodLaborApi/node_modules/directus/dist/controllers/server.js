...
router.get('/specs/graphql/:scope?', async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const service = new services_2.SpecificationService({
        accountability: req.accountability,
        schema: req.schema,
    });
    ...
    const info = yield serverService.serverInfo();
    const result = yield service.graphql.generate(scope);
    const filename = info.project.project_name + '_' + date_fns_1.format(new Date(), 'yyyy-MM-dd') + '.graphql';
