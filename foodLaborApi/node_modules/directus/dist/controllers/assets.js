...
async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (transformation.hasOwnProperty('quality') &&
        ...
        throw new exceptions_1.InvalidQueryException(`"quality" Parameter has to between 1 to 100`);
    }
...
async_handler_1.default((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    res.setHeader('Cache-Control', `${access}, max-age=${ms_1.default(env_1.default.ASSETS_CACHE_TTL) / 1000}`);
    if (range) {
