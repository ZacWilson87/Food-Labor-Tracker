...
router.get(['/:type', '/:type/*'], async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    if (appExtensions.includes(req.params.type) === false) {
        throw new exceptions_1.RouteNotFoundException(req.path);
    }
    return next();
})), express_1.default.static(extensionsPath), async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
