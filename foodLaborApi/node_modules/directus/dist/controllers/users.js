...
router.post('/', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        if (Array.isArray(req.body)) {
            const items = yield service.readMany(savedKeys, req.sanitizedQuery);
            res.locals.payload = { data: items };
        }
        else {
            const item = yield service.readOne(savedKeys[0], req.sanitizedQuery);
...
router.get('/me', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const item = yield service.readOne(req.accountability.user, req.sanitizedQuery);
...
router.get('/:pk', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const items = yield service.readOne(req.params.pk, req.sanitizedQuery);
...
router.patch('/me', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const primaryKey = yield service.updateOne(req.accountability.user, req.body);
    const item = yield service.readOne(primaryKey, req.sanitizedQuery);
    res.locals.payload = { data: item || null };
    return next();
})), respond_1.respond);
router.patch('/me/track/page', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield service.updateOne(req.accountability.user, { last_page: req.body.last_page });
    return next();
})), respond_1.respond);
