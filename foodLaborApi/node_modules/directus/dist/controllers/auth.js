...
router.post('/refresh', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
...
router.post('/logout', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const accountability = {
        ip: req.ip,
        userAgent: req.get('user-agent'),
        role: null,
...
router.get('/oauth/:provider', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    let hookPayload = {
        ...
        redirect: (_d = req.query) === null || _d === void 0 ? void 0 : _d.redirect,
    };
    emitter_1.emitAsyncSafe(`oauth.${req.params.provider}.redirect`, {
    ...
    yield emitter_1.default.emitAsync(`oauth.${req.params.provider}.redirect.before`, {
...
router.get('/oauth/:provider/callback', async_handler_1.default((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    yield emitter_1.default.emitAsync(`oauth.${req.params.provider}.login.before`, hookPayload, {
    ...
    const emitStatus = (status) => {
        emitter_1.emitAsyncSafe(`oauth.${req.params.provider}.login`, hookPayload, {
    ...
    try {
        const email = get_email_from_profile_1.default(req.params.provider, (_e = req.session.grant.response) === null || _e === void 0 ? void 0 : _e.profile);
        (_f = req.session) === null || _f === void 0 ? void 0 : _f.destroy(() => { });
        authResponse = yield authenticationService.authenticate({
            email,
        });
    }
    catch (error) {
