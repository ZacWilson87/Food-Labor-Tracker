            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                for (const field of fields) {
                    const isRelational = field.includes('.') ||
                        ...
                        // anything
                        !!schema.relations.find((relation) => relation.one_collection === parentCollection && relation.one_field === field);
                    if (isRelational) {
                        // field is relational
                ...
                for (const [relationalField, nestedFields] of Object.entries(relationalStructure)) {
                    ...
                    if (relationType === 'm2a') {
                        ...
                        for (const relatedCollection of allowedCollections) {
                            child.children[relatedCollection] = yield parseFields(relatedCollection, Array.isArray(nestedFields) ? nestedFields : nestedFields[relatedCollection] || ['*'], deep === null || deep === void 0 ? void 0 : deep[`${relationalField}:${relatedCollection}`]);
